...
router.post('/chat', (req, res) => {
    ...
    if (lower.includes('hi') || lower.includes('hello'))
        reply = "Hello there! I am Ellama 3, your AI library assistant. Need a book recommendation?";
    else if (lower.includes('sci-fi') || lower.includes('science fiction'))
        reply = "For Sci-Fi, 'Project Hail Mary' by Andy Weir or 'Dune' by Frank Herbert are absolute must-reads right now!";
    else if (lower.includes('free'))
        reply = "Yes! Every single book on BookHaven is 100% free forever.";
